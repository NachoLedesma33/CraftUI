...
const LANDING_PAGE_TEMPLATE: Template = {
  ...
  description: 'Professional landing page with hero section, features grid, pricing table, and footer',
  category: 'landing',
...
const ADMIN_DASHBOARD_TEMPLATE: Template = {
  ...
  description: 'Complete dashboard layout with sidebar, navbar, and metric cards',
  category: 'dashboard',
  thumbnail: createPlaceholderThumbnail(),
  ...
  data: {
    components: {
      ...
      'dashboard-content-1': {
        ...
        parent: 'main-content-1',
        children: ['metric-card-1', 'metric-card-2', 'metric-card-3', 'metric-card-4'],
 ...
 */
export function getPredefinedTemplatesByCategory(
  category: string
): Template[] {

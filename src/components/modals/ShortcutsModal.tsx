      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-slate-800 border border-slate-700 rounded-lg shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col">
          ...
          <div className="overflow-y-auto p-6 space-y-6">
            ...
            {/* Help Section */}
            <ShortcutCategory category="Help" shortcuts={groupedShortcuts.Help} />
            ...
            <div className="mt-6 pt-4 border-t border-slate-700">
              ...
              <ul className="text-xs text-slate-400 space-y-1">
                <li>• Platform-specific: Use <kbd className="px-1.5 py-0.5 bg-slate-700 rounded text-slate-200 text-xs">Cmd</kbd> on Mac instead of <kbd className="px-1.5 py-0.5 bg-slate-700 rounded text-slate-200 text-xs">Ctrl</kbd></li>
                <li>• Type-safe: Shortcuts are disabled while editing text in inputs</li>
                <li>• Press <kbd className="px-1.5 py-0.5 bg-slate-700 rounded text-slate-200 text-xs">?</kbd> anytime to show this overlay</li>
              </ul>
            </div>
          </div>

        ...
        >
          ...
          {(!rootComponent || !hasChildren) && (
            <div className="flex flex-col items-center justify-center py-24 px-8 select-none">
              <div className="w-16 h-16 bg-[#f5f0eb] flex items-center justify-center mb-5 border-2 border-black">
                <span className="text-2xl opacity-60">+</span>
              </div>
              <p className="text-base font-semibold text-[#4b5563] mb-2">Canvas vacío</p>
              <p className="text-sm text-[#6b7280] text-center max-w-xs leading-relaxed">
                ...
                <kbd className="px-1.5 py-0.5 bg-[#f5f0eb] border-2 border-black text-xs text-[#4b5563] font-mono">Ctrl+K</kbd>{" "}

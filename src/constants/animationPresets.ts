...
export const ANIMATION_PRESETS: Record<string, AnimationPreset> = {
  ...
  slideInTop: {
    ...
    keyframes: [
      {
        percent: 0,
        properties: { transform: "translateY(-100px)", opacity: "0" },
      },
      {
        percent: 100,
  ...
  slideInLeft: {
    ...
    keyframes: [
      {
        percent: 0,
        properties: { transform: "translateX(-100px)", opacity: "0" },
      },
      {
        percent: 100,
  ...
  flip: {
    ...
    keyframes: [
      ...
      {
        percent: 100,
        properties: { transform: "rotateY(360deg)", opacity: "1" },
      },
    ],
  },
  skew: {
    ...
    keyframes: [
      ...
      {
        percent: 100,
        properties: { transform: "skewY(-10deg)", opacity: "1" },
      },
    ],
  },
};
